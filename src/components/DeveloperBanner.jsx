export function DeveloperBanner() {
  return (
    <section className="mt-14 rounded-3xl border border-indigo-100 bg-indigo-50 p-6 sm:p-8">
      <p className="text-sm font-semibold uppercase tracking-wider text-indigo-700">Developer Registration</p>
